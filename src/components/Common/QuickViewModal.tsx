...
const QuickViewModal = () => {
  ...
  const resetQuickView = useQuickViewStore((state) => state.resetQuickView);
  ...
  }, [product?.hasVariants, product?.variants, product?.stock]);
  ...
  const handleAddToCart = () => {
    ...
    if (product.hasVariants) {
      toast.error("Vui lòng chọn các tùy chọn sản phẩm trước khi thêm vào giỏ hàng");
      closeModal();
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-1.5">
                  {!ratingLoading && totalReviews > 0 ? (
                    <>
                      ...
                      <span>
                        <span className="font-medium text-dark">
                          {averageRating.toFixed(1)} Đánh giá
                        </span>
                    ...
                    <span className="text-dark-2">Chưa có đánh giá</span>
                  )}
                </div>
