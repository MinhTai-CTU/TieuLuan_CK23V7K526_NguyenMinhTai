...
export default function MessengerButton() {
  const handleMessengerClick = () => {
    ...
    // Can be implemented later with actual chat integration
  ...
  return (
    <button
      ...
      className="flex items-center justify-center w-14 h-14 rounded-full shadow-lg bg-blue ease-out duration-200 hover:bg-blue-dark fixed bottom-8 right-8 z-999"
