...
const Header = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    // Kịch bản 1: Có từ khóa tìm kiếm (Scoped Search)
    if (trimmedQuery) {
    ...
    // Kịch bản 2: Không có từ khóa, chỉ có category (Category Redirect)
    else if (selectedCategoryId) {
      router.push(`/shop-without-sidebar?categoryId=${selectedCategoryId}`);
    }
    // Nếu không có gì cả, không làm gì
  };
                ...
                {isAuthenticated && user ? (
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center text-custom-sm text-dark font-medium">
