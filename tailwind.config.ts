...
const config: Config = {
  ...
  safelist: [
    // Pattern matching for all gradient classes (from, via, to)
    // Bao gồm tất cả các màu Tailwind mặc định: slate, gray, zinc, neutral, stone, red, orange, amber, yellow, lime, green, emerald, teal, cyan, sky, blue, indigo, violet, purple, fuchsia, pink, rose
    {
      pattern:
    ...
    // Pattern matching for gradient directions
    {
